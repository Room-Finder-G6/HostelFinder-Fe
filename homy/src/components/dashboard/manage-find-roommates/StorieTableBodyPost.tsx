...
const StoriePostsBody: React.FC<UserPostsBodyProps> = ({ posts, loading, onDeleteClick }) => {
                ...
                return (
                    <tr key={post.id}>
                            ...
                            <div className="d-flex align-items-start">
                                ...
                                <div>
                                    ...
                                    <p className={styles.address}>
                                        {post.addressStory?.commune && post.addressStory?.district && post.addressStory?.province
                                            ? `${post.addressStory.commune}, ${post.addressStory.district}, ${post.addressStory.province}`
                        ...
                        <td style={{ verticalAlign: 'middle', whiteSpace: 'nowrap' }}>
                            <span
                                className={`${styles.badge} ${post.bookingStatus ? styles.success : styles.danger
                                    }`}
                            >
                                {post.bookingStatus ? 'Họat động' : 'Ẩn'}
                            </span>
                        </td>
...
export default StoriePostsBody;
